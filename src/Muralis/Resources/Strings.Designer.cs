...
public static class Strings
{
    ...
    public static string Wallhaven_AutoFitDesc => Get(nameof(Wallhaven_AutoFitDesc));
    public static string Wallhaven_Categories => Get(nameof(Wallhaven_Categories));
    public static string Wallhaven_CategoryAnime => Get(nameof(Wallhaven_CategoryAnime));
    public static string Wallhaven_CategoryGeneral => Get(nameof(Wallhaven_CategoryGeneral));
    public static string Wallhaven_CategoryPeople => Get(nameof(Wallhaven_CategoryPeople));
    public static string Wallhaven_NsfwKeyWarning => Get(nameof(Wallhaven_NsfwKeyWarning));
    public static string Wallhaven_Purity => Get(nameof(Wallhaven_Purity));
    public static string Wallhaven_PurityNsfw => Get(nameof(Wallhaven_PurityNsfw));
    public static string Wallhaven_PuritySfw => Get(nameof(Wallhaven_PuritySfw));
    public static string Wallhaven_PuritySketchy => Get(nameof(Wallhaven_PuritySketchy));
    public static string Wallhaven_RatiosPlaceholder => Get(nameof(Wallhaven_RatiosPlaceholder));
    public static string Wallhaven_TagsCaption => Get(nameof(Wallhaven_TagsCaption));
    public static string Wallhaven_TagsPlaceholder => Get(nameof(Wallhaven_TagsPlaceholder));
